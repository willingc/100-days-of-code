# #100DaysOfCode Challenge for Julia and Front-end Web Dev

Focus on using Julia for computational narratives within a
notebook. Learn more front-end web development to customize
these narratives.
